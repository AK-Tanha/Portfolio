  ...
  return (
    <div className="min-h-screen bg-body pt-24 pb-12 px-5">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-card rounded-3xl p-8 md:p-12 shadow-sm border border-default">
          <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-8 mb-10 pb-10 border-b border-default">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-card rounded-2xl flex items-center justify-center shadow-md p-4 shrink-0 transition-transform hover:scale-105 duration-300">
              <Image 
            ...
            <div>
              <h1 className="text-3xl md:text-5xl font-ovo font-bold text-body mb-4">
                {service.title}
              </h1>
          ...
          <div className="max-w-none">
            <h2 className="text-2xl md:text-3xl font-semibold text-body mb-6 font-ovo">
              Service Overview
            </h2>
            ...
            <h2 className="text-2xl md:text-3xl font-semibold text-body mt-12 mb-6 font-ovo">
              What You Can Expect
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              {[
                ...
                <div key={index} className="flex gap-4 p-5 bg-card rounded-xl border border-default shadow-sm">
