    ...
    <div className='w-11/12 max-w-3xl text-center mx-auto py-16 sm:py-24 flex flex-col items-center'>
      <div>
        <Image src={assets.ak_pro} alt='' className='rounded-full w-32 h-32' />
            ...
            <h3 className='flex items-end gap-2 text xl md:text 2xl mb-3 font-ovo'>Hi! I'm AK Tanha <Image src={assets.hand_icon} alt='' className='w-8' /></h3>
            <h1 className='text-3xl sm:text-6xl md:text-[66px] font-ovo'>A MERN stack developer based in Bangladesh</h1>
            <p className='max-w-2xl mx-auto font-ovo'>I am a MERN Stack Developer from Bangladesh building responsive, full-stack web apps with clean UI and scalable backend.</p>
